...
function useInView<T extends Element = HTMLDivElement>(options: IntersectionObserverInit = {}): [React.RefObject<T>, boolean] {
          ...
          <div className="max-w-7xl mx-auto space-y-16 lg:space-y-24">
            ...
            >
              <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                <div
                  className={`flex flex-col justify-center items-center md:items-start text-center md:text-left transition-all duration-1000 ${section3InView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                    }`}
                >
                  ...
                  <p className="text-[22px] text-gray-700 max-w-xl">
                    Conecta tu punto de venta, tu equipo de ventas y tus integraciones en un solo sistema.
                  </p>
                </div>

                <div
                  className={`flex justify-center transition-all duration-1000 delay-300 ${section3InView ? 'opacity-100 scale-100' : 'opacity-0 scale-90'
                    }`}
                >
                  <img
                    src="/bmkt/bmkt3.png"
            ...
            <div
              ref={section4Ref}
              className="bg-white py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center"
            >
