  ...
  const pricingPlans = [
    {
      ...
      buttonClass:
        "bg-white shadow-[0px_1px_1px_-0.5px_rgba(16,24,40,0.20)] outline outline-0.5 outline-[#1e29391f] outline-offset-[-0.5px] text-gray-800 text-shadow-[0px_1px_1px_rgba(16,24,40,0.08)] hover:bg-gray-100",
    },
    {
      name: "Pro",
      monthlyPrice: "$20",
      ...
      buttonText: "Join now",
      buttonClass:
        "bg-white shadow-[0px_1px_1px_-0.5px_rgba(16,24,40,0.20)] text-gray-800 text-shadow-[0px_1px_1px_rgba(16,24,40,0.08)] hover:bg-gray-100",
      popular: true,
    },
    {
      name: "Ultra",
        ...
        {pricingPlans.map((plan) => (
          <div
            ...
            className={`flex-1 p-4 overflow-hidden rounded-xl flex flex-col justify-start items-start gap-6 ${
              plan.popular 
                ? "bg-gradient-to-br from-cyan-400 to-white shadow-[0px_4px_8px_-2px_rgba(0,0,0,0.10)]" 
          ...
          >
            <div className="self-stretch flex flex-col justify-start items-start gap-6">
              <div className="self-stretch flex flex-col justify-start items-start gap-8">
                <div
                  className={`w-full h-5 text-sm font-medium leading-tight ${
                    plan.popular ? "text-gray-800" : "text-zinc-200"
                  }`}
                >
                  {plan.name}
                  {plan.popular && (
                    <div className="ml-2 px-2 overflow-hidden rounded-full justify-center items-center gap-2.5 inline-flex mt-0 py-0.5 bg-white">
                      <div className="text-center text-gray-800 text-xs font-normal leading-tight break-words">
                        Popular
                      </div>
                    </div>
                  )}
                  ...
                  <div className="flex justify-start items-center gap-1.5">
                    <div
                      className={`relative h-10 flex items-center text-3xl font-medium leading-10 ${
                        plan.popular ? "text-gray-800" : "text-zinc-50"
                      }`}
                    >
                    ...
                    <div
                      className={`text-center text-sm font-medium leading-tight ${
                        plan.popular ? "text-gray-600" : "text-zinc-400"
                      }`}
                    >
                      /month
                    </div>
              ...
              {/* Botón */}
              <button
                className={`self-stretch px-5 py-3 rounded-md flex justify-center items-center transition-all duration-200 ${plan.buttonClass}`}
              >
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              <div
                className={`self-stretch text-sm font-medium leading-tight ${
                  plan.popular ? "text-gray-600" : "text-muted-foreground"
                }`}
              >
                    ...
                    <div className="w-4 h-4 flex items-center justify-center">
                      <Check
                        className={`w-full h-full ${
                          plan.popular ? "text-gray-800" : "text-muted-foreground"
                        }`}
                        strokeWidth={2}
                      />
                    </div>
