...
const faqData = [
  {
    question: "¿Qué es Black Sheep y quiénes pueden usar nuestras soluciones?",
    answer:
  ...
  {
    question: "¿Puedo integrar sus soluciones con mis herramientas actuales?",
    answer:
  ...
  {
    question: "¿Cómo saber qué proyecto o plataforma necesito?",
    answer:
  ...
  {
    question: "¿Qué beneficios ofrece trabajar con Black Sheep?",
    answer: (
  ...
  {
    question: "¿Ofrecen soporte o mantenimiento después del desarrollo?",
    answer:
  ...
  {
    question: "¿Puedo solicitar una demo o una consultoría?",
    answer:
...
export function FAQSection() {
  ...
  return (
    <section className="w-full pt-[10px] pb-10 md:pb-20 px-5 relative flex flex-col justify-center items-center">
